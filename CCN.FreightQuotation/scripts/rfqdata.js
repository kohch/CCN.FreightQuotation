...
rfqSummaryData.prototype = function() {
    ...
    var requestSummary = {
        ...
        requestQuotation: [
            ...
            { requestID: '8563527F-453A-4C9B-9FE7-F12BF1A12F94', origin: 'HKG', destination: 'SIN',pieces: '440', weight: '4200', volume: '21300', status: 'Accepted', createDT: '2014-01-02 15:00', expireOn: '2014-01-23 11:00', LogeInDT: '2014-01-21 14:00', collectionDT: '2014-01-21 11:00', commodity: '', goodsDescription: 'Book2' },
            { requestID: 'B7567C91-F982-4576-A270-B2C2ECCEEAB0', origin: 'SIN', destination: 'HKG',pieces: '540', weight: '200', volume: '7300', status: 'Rejected', createDT: '2014-01-03 10:00', expireOn: '2014-01-22 11:00', LogeInDT: '2014-01-20 15:00', collectionDT: '2014-01-21 11:00', commodity: '', goodsDescription: 'Home2' },
            { requestID: 'C1234C91-F982-4576-A270-B2C2ECCEEAB0', origin: 'SIN', destination: 'SYD',pieces: '5140', weight: '2200', volume: '4300', status: 'No Flight', createDT: '2014-01-13 10:00', expireOn: '2014-01-30 11:00', LogeInDT: '2014-01-24 15:00', collectionDT: '2014-01-25 11:00', commodity: '', goodsDescription: 'My Notebook 5' },
		]
	},
