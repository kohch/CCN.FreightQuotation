...
quotationApp.prototype = function() {
    ...
    _handleDataForRFQSummary = function (data) {
		...
		for (var i in data.requestQuotation) {
           ...
           $myRFQSummary.append('<div><a href="viewRFQDetail.html" rel="external"><div class="ui-corner-all custom-corners"><div class="ui-bar ui-bar-c"><h3>RFQ ' + i + 1 + '</h3></div><div class="ui-body ui-body-c"><table><tr><th>'
            ...
            + rfq.expireOn + '</td></tr></table></div></div></div></a><br />');
		}
